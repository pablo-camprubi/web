const metrics = [
  { value: "3.2x", label: "Avg ROAS Increase", description: "Better returns" },
  { value: "68%", label: "Time Saved", description: "Less manual work" },
  { value: "<5min", label: "Response Time", description: "Instant execution" },
  { value: "$2M+", label: "Ad Spend Managed", description: "Proven at scale" },
]
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-zinc-500 max-w-lg mx-auto text-balance">
            Real results from AI-powered campaign management
          </p>
        </div>
